...
function useCategoryHrefWithSSRFallback(item: any) {
...
export default function DocSidebarItemCategory(props: any): React.JSX.Element {
...
function isCategoryWithHref(category: any) {
