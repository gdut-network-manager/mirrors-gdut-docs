...
| **Nexus 缓存代理** | `https://repo.gdut.edu.cn/repository/rubygems/` |
...
---
:sources:
- https://repo.gdut.edu.cn/repository/rubygems/
:update_sources: true
:verbose: true
:backtrace: false
:bulk_threshold: 1000
...
```bash
bundle config set --global mirror.https://rubygems.org https://repo.gdut.edu.cn/repository/rubygems
```
...
# source 'https://rubygems.org'
# 替换为镜像源
source 'https://repo.gdut.edu.cn/repository/rubygems/'
